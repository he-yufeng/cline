...
Plugins are packages of reusable agent capabilities. They let you bundle tools, skills, lifecycle hooks, commands, and configuration into a single module that can be shared across projects or published for others to use.
